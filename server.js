...
const EXPLICIT_WORDS = [
  'anal','analed','analing','anally','analsex','anus','anuses',
  'arse','arsebag','arsebags','arsebandit','arsebandits','arsed','arsefuck','arsefucked','arsefucker','arsefuckers','arsefucking','arsefucks','arsehat','arsehats','arsehead','arseheads','arsehole','arseholes','arses','arsewipe','arsewipes',
  'ass','assbag','assbags','assbang','assbanged','assbanger','assbangers','assbanging','assbangs','assbreath','assclown','assclowns','asscock','asscocks','asscracker','asscrackers','asscrack','asscracks','assdick','assdicks','assed','asses','assface','assfaces','assfuck','assfucked','assfucker','assfuckers','assfucking','assfucks','assgoblin','assgoblins','asshat','asshats','asshattery','asshead','assheads','asshole','assholery','assholes','assholish','asslick','asslicked','asslicker','asslickers','asslicking','asslicks','asslover','asslovers','assmaster','assmasters','assmonkey','assmonkeys','assmunch','assmuncher','assmunchers','assmunches','assmunching','assplay','asspuppy','asspuppies','asspirate','asspirates','assram','assrammer','assrammers','assramming','assrams','asssucker','asssuckers','asswad','asswads','asswagon','asswagons','asswipe','asswiped','asswiper','asswipers','asswipes','asswiping','autoerotic','autoerotism',
  'ballbag','ballbags','ballsack','ballsacks','ballsucker','ballsuckers','bastard','bastardly','bastards','beaner','beaners','beaver','beavers','biatch','biatches','bigot','bigotry','bigots','bimbo','bimbos','bint','bints',
  'bitch','bitchass','bitchasses','bitched','bitcher','bitchers','bitches','bitchier','bitchiest','bitchin','bitching','bitchtits','bitchy',
  'blowjob','blowjobs','blumpkin','blumpkins','bollock','bollocks','boner','boners','boob','boobies','boobs','booby','bukkake',
  'bullshit','bullshits','bullshitted','bullshitter','bullshitters','bullshitting',
  'bunghole','bungholes','butt','buttbang','buttbanged','buttbanger','buttbangers','buttbanging','buttbangs','buttcheek','buttcheeks','buttface','buttfaces','buttfuck','buttfucked','buttfucker','buttfuckers','buttfucking','buttfucks','butthead','buttheads','butthole','buttholes','buttmunch','buttmuncher','buttmunchers','buttmunches','buttmunching','buttplug','buttplugs',
  'camwhore','camwhores','carpetmuncher','carpetmunchers','chickenfucker','chickenfuckers','chinaman','chinamen','chink','chinks','choad','choads','chode','chodes','chuff','chuffer','chuffers','chuffing','chuffs','circlejerk','circlejerks',
  'clit','clitfuck','clitfucked','clitfucker','clitfuckers','clitfucking','clitfucks','clits','clitoris','clitorises','clitty','clitties','clusterfuck','clusterfucks',
  'cock','cockass','cockasses','cockbag','cockbags','cockblock','cockblocked','cockblocker','cockblockers','cockblocking','cockblocks','cockboy','cockboys','cockface','cockfaces','cockfucker','cockfuckers','cockhead','cockheads','cockknob','cockknobs','cockmaster','cockmasters','cockmonkey','cockmonkeys','cockmonster','cockmonsters','cockmunch','cockmuncher','cockmunchers','cockmunching','cocknose','cocknoses','cocknut','cocknuts','cockpipe','cockpipes','cocks','cocksmith','cocksmiths','cocksniffer','cocksniffers','cocksuck','cocksucked','cocksucker','cocksuckers','cocksucking','cocksucks','cockwaffle','cockwaffles',
  'coochie','coochies','coon','coonass','coonasses','coons','cooter','cooters','cornhole','cornholed','cornholes','cornholing',
  'crackbaby','crackbabies','crackhead','crackheads','crackho','crackhoes','crackhouse','crackhouses','crackwhore','crackwhores',
  'crap','crapped','crapper','crappers','crappier','crappiest','crapping','crappy','craps','creampie','creampied','creampies','creampieing','cretin','cretins','crotch','crotchrocket','crotchrockets',
  'cum','cumbag','cumbags','cumbubble','cumbubbles','cumdumpster','cumdumpsters','cumguzzler','cumguzzlers','cumjockey','cumjockeys','cummed','cumming','cums','cumshot','cumshots','cumslut','cumsluts','cumstain','cumstains','cumtart','cumtarts',
  'cunilingus','cunnilingus','cunt','cuntbag','cuntbags','cuntface','cuntfaces','cuntfuck','cuntfucker','cuntfuckers','cuntfucking','cunthole','cuntholes','cunthunter','cunthunters','cuntlick','cuntlicker','cuntlickers','cuntlicking','cuntlicks','cuntmuncher','cuntmunchers','cuntmunching','cunts','cuntsicle','cuntsicles','cuntspaz','cuntspazzes',
  'damn','damned','damning','damns','damnit','dammit','darkie','darkies','deepthroat','deepthroated','deepthroater','deepthroaters','deepthroating','deepthroats',
  'dick','dickbag','dickbags','dickbeater','dickbeaters','dickbeating','dickface','dickfaces','dickfuck','dickfucked','dickfucker','dickfuckers','dickfucking','dickfucks','dickhead','dickheads','dickhole','dickholes','dickjuice','dickjuices','dickless','dicklick','dicklicker','dicklickers','dicklicking','dicklicks','dickmonger','dickmongers','dicks','dickslap','dickslapper','dickslappers','dickslapping','dickslaps','dicksuck','dicksucker','dicksuckers','dicksucking','dicksucks','dickwad','dickwads','dickweasel','dickweasels','dickweed','dickweeds','dickwod','dickwods',
  'dildo','dildos','dink','dinks','dipshit','dipshits','dipstick','dipsticks','doggie','doggystyle','doggystyles','dong','dongs','dookie','dookies',
  'douche','douchebag','douchebags','douched','douches','douchewaffle','douchewaffles','douchey','douching',
  'dumbass','dumbasses','dumbcunt','dumbcunts','dumbfuck','dumbfucks','dumbshit','dumbshits','dumbtwat','dumbtwats','dyke','dykes',
  'ejaculate','ejaculated','ejaculates','ejaculating','ejaculation','ejaculations','ejaculator','ejaculators',
  'erect','erected','erecting','erection','erections','erects','erotic','erotica','erotically','erotism',
  'fag','fagbag','fagbags','fagdom','fagged','fagging','faggit','faggity','faggot','faggotcock','faggotcocks','faggotry','faggots','faggoty','fags','fagtard','fagtards',
  'fanny','fannies','fap','fapped','fapper','fappers','fapping','faps',
  'fartbag','fartbags','farted','farter','farters','fartface','fartfaces','farting','fartknocker','fartknockers','farts','fatass','fatasses',
  'felch','felched','felcher','felchers','felches','felching','fellatio','feltch','feltcher','feltchers','feltching',
  'fingerbang','fingerbanged','fingerbanger','fingerbangers','fingerbanging','fingerbangs','fingerfuck','fingerfucked','fingerfucker','fingerfuckers','fingerfucking','fingerfucks',
  'fistfuck','fistfucked','fistfucker','fistfuckers','fistfucking','fistfucks','fooker','fookers','fookin','fooking',
  'footfuck','footfucked','footfucker','footfuckers','footfucking','footfucks','frigger','friggers','frigging',
  'fuck','fuckable','fucked','fucker','fuckers','fuckface','fuckfaces','fuckhead','fuckheads','fuckhole','fuckholes','fuckin','fucking','fuckings','fuckme','fuckmeat','fucknugget','fucknuggets','fuckoff','fuckoffs','fucks','fuckstick','fucksticks','fucktard','fucktards','fucktwat','fucktwats','fuckup','fuckups','fuckwad','fuckwads','fuckwhit','fuckwhits','fuckwit','fuckwits','fudgepacker','fudgepackers','fugly',
  'gangbang','gangbanged','gangbanger','gangbangers','gangbanging','gangbangs','gayass','gayasses','gaybob','gaybobs','gayboy','gayboys','gaycock','gaycocks','gayfuck','gayfucker','gayfuckers','gayfucking','gayfucks','gaylord','gaylords','gaytard','gaytards','gaywad','gaywads','gigolo','gigolos',
  'godcursed','goddam','goddammit','goddamn','goddamned','goddamning','goddamnit','goddamns','gook','gooks','gringo','gringos',
  'handjob','handjobs','hardon','hardons','hell','hellbent','hellish','hentai','hermaphrodite','hermaphrodites','heshe','heshes','hick','hicks','hillbilly','hillbillies','hitler','hitlers',
  'hoe','hoes','hoer','hoers','homo','homoerotic','homos','homosexual','homosexuality','homosexuals','hooker','hookers','hornbag','hornbags','horny','horseshit','horseshits',
  'hotbox','hotboxed','hotboxes','hotboxing','hump','humped','humper','humpers','humping','humps',
  'incest','intercourse',
  'jackass','jackasses','jackoff','jackoffs','jagoff','jagoffs','jailbait','jailbaits','jap','japs','jerkoff','jerkoffs','jigaboo','jigaboos','jissom','jissoms','jiz','jizm','jizz','jizzed','jizzes','jizzing','jizzy',
  'kike','kikes','killyourself','knob','knobend','knobends','knobhead','knobheads','knobjocky','knobs','kooch','kootch','kraut','krauts','kunt','kunts','kyke','kykes',
  'labia','labias','lardass','lardasses','lesbo','lesbos','libtard','libtards','limpdick','limpdicks','livesex','lubejob','lubejobs',
  'mafucker','mafuckers','masochist','masochists','masturbate','masturbated','masturbater','masturbaters','masturbates','masturbating','masturbation','masturbations',
  'meth','methhead','methheads','midget','midgets','milf','milfs','minge','minger','minges','mof','mofo','mofos',
  'molest','molested','molester','molesters','molesting','molests','mong','mongoloid','mongoloids','mongs','moolie','moolies','moron','morons',
  'motherfuck','motherfucked','motherfucker','motherfuckers','motherfuckin','motherfucking','motherfucks',
  'muff','muffdive','muffdived','muffdiver','muffdivers','muffdiving','muffdives','muffs',
  'muthafucka','muthafuckas','muthafucker','muthafuckers','muthafucking',
  'nads','nazi','nazis','necrophiliac','negro','negroes','niglet','niglets','nig','nigga','niggas','nigger','niggered','niggering','niggers',
  'nimrod','nimrods','nip','nipple','nipples','nips','nob','nobhead','nobheads','nobs','nonce','nonces','numbnut','numbnuts','nutsack','nutsacks','nutter','nutters',
  'oral','organ','organs','orgasm','orgasmed','orgasmic','orgasming','orgasms','orgy','orgies',
  'paedo','paedos','paedophile','paedophiles','pakis','paki','panooch','panties','panty','peckerhead','peckerheads','peckers','pecker',
  'pedo','pedophile','pedophiles','pedophilia','pedos','penis','penises','perv','perve','perved','perves','pervert','perverted','perversion','perversions','pervo','pervos','pervs',
  'piss','pissed','pisser','pissers','pisses','pissflaps','pissing','pissoff','pissy',
  'polack','polacks','poof','pooftah','poofter','poofters','poofs','poon','poons','poontang','poontangs',
  'poop','pooper','poopers','poopface','poopfaces','pooping','poops','poopy','porchmonkey','porchmonkeys',
  'porn','porno','pornography','pornographic','pornos','prick','pricked','pricking','pricks','prig','prigs','pron','prons','prostitute','prostitutes',
  'pube','pubes','punani','punanis','punannies','punany','punta','puntas','pussies','pussy','pussyfart','pussyfarts','pussylicker','pussylickers','pussylicking','pussylicks','pussylover','pussylovers','pussypounder','pussypounders',
  'queef','queefed','queefing','queefs','queer','queers','queerbait','queerbaits','queerbo','queerbos','quim',
  'racist','racism','racists','raghead','ragheads','randy','rape','raped','raper','rapers','rapes','raping','rapist','rapists','rectum','rectums','redneck','rednecks',
  'retard','retarded','retards','rimjob','rimjobs',
  'sandnigger','sandniggers','scag','scags','scank','scanks','schlong','schlongs','screw','screwed','screwing','screws','scromp','scrotum','scrotums','scumbag','scumbags',
  'semen','semens','sexed','sexes','sexist','sexists','sexcam','sexcams','sexpot','sexpots','sextape','sextapes','sexually','sexy',
  'shag','shagged','shagger','shaggers','shagging','shags','shemale','shemales',
  'shit','shitass','shitasses','shitbag','shitbags','shitbird','shitbirds','shitblimp','shitblimps','shitbrain','shitbrains','shitbreath','shitcanned','shitcunt','shitcunts','shitdick','shitdicks','shited','shiteater','shiteaters','shites','shitey','shitface','shitfaced','shitfaces','shitforbrains','shitfuck','shitfucker','shitfuckers','shitfucking','shitfucks','shitfull','shithead','shitheads','shithole','shitholes','shithouse','shithouses','shitkicker','shitkickers','shitload','shitloads','shitlord','shitlords','shitmuncher','shitmunchers','shits','shitspitter','shitstain','shitstains','shitstick','shitstorm','shitstorms','shitter','shitters','shittier','shittiest','shitting','shittin','shitty','shitwhore','shiz','shizz','shizzle',
  'sissy','skank','skanks','skanky','sleaze','sleazes','sleazebag','sleazebags',
  'slut','slutbag','slutbags','slutface','slutfaces','sluts','slutty','smegma','smut','smuts','snatch','snatches',
  'sodom','sodomite','sodomites','sodomize','sodomized','sodomizes','sodomizing',
  'spaz','spazz','spazzed','spazzes','spazzing','spazzy','sperm','sperms','spic','spicks','spics','spook','spooks','spunk','spunks',
  'stripper','strippers','stupidass','stupidasses','suckass',
  'tampon','tampons','tard','tards','taintlicker','taintlickers','teabag','teabagged','teabagger','teabaggers','teabagging','teabags',
  'testicle','testicles','threesome','threesomes','throating','tit','titbag','titbags','titfuck','titfucked','titfucker','titfuckers','titfucking','titfucks','tits','tittie','titties','titty','tittyfuck','tittyfucked','tittyfucker','tittyfuckers','tittyfucking','tittyfucks','tonguefuck','tonguefucks',
  'toolbag','toolbags','tosser','tossers','towelhead','towelheads','tramp','tramps','tranny','trannies','trashbag','trashbags',
  'turd','turdface','turdfaces','turds','twat','twatface','twatfaces','twathead','twatheads','twatlip','twatlips','twats','twatwaffle','twatwaffles','twink','twinkie','twinkies','twinks',
  'unclefucker','unclefuckers','urinate',
  'vagina','vaginal','vaginas','vibrator','vibrators','vulva',
  'wank','wanked','wanker','wankers','wanking','wanks','wankjob','wankjobs','wankstain','wankstains','wanky',
  'wedgie','wedgies','wetback','wetbacks','whoreface','whorefaces','whore','whored','whorehouse','whorehouses','whores','whoring','whorish',
  'wigger','wiggers','wiggery','willy','willies','wog','wogs','wop','wops',
  'xrated','xxx','yobbo','yobs','zoophile','zoophilia',
];
